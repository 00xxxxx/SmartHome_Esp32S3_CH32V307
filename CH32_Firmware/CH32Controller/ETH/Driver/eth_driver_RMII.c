...
/* Network core global variable definition */
...
u16 RecvLen[WCHNET_MAX_SOCKET_NUM];                              //Socket receive length
u8  ConnStatus;                                                 //Connection status
u8  MyIP[4];                                                    //IP address obtained by DHCP
 ...
 * @return  none
 */
void WCHNET_GetMacAddr( u8 *p )
{
    u32 mac_addr0, mac_addr1;

    mac_addr0 = (*(u32*) (0x1FFFF7E8));
    mac_addr1 = (*(u32*) (0x1FFFF7EC));
